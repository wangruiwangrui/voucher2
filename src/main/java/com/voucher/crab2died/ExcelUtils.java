...
package com.voucher.crab2died;

import com.voucher.crab2died.converter.DefaultConvertible;
import com.voucher.crab2died.exceptions.Excel4JException;
import com.voucher.crab2died.exceptions.Excel4jReadException;
import com.voucher.crab2died.handler.ExcelHeader;
import com.voucher.crab2died.handler.SheetTemplate;
import com.voucher.crab2died.handler.SheetTemplateHandler;
...
import com.voucher.crab2died.utils.Utils;
...
public final class ExcelUtils {
     ...
     * @param clazz      待绑定的类(绑定属性注解{@link com.voucher.crab2died.annotation.ExcelField})
    ...
    public List<List<String>> readExcel2(Workbook wb, int offsetLine, int limitLine, int sheetIndex)
            throws IOException, InvalidFormatException {
    ...
    /**
     * 基于Excel模板与注解{@link com.voucher.crab2died.annotation.ExcelField}导出Excel
     *
    ...
    /**
     * 基于Excel模板与注解{@link com.voucher.crab2died.annotation.ExcelField}导出多sheet的Excel
     *
     ...
     *
     * @param data          待导出数据
     * @param clazz         {@link com.voucher.crab2died.annotation.ExcelField}映射对象Class
     * @param isWriteHeader 是否写入表头
