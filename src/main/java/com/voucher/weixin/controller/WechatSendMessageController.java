...
public class WechatSendMessageController {
	...
	ClassPathXmlApplicationContext mysqlApplicationContext = new ClassPathXmlApplicationContext("spring-mybatis2.xml");
	...
	@RequestMapping("/send")
	public @ResponseBody Integer template(@RequestParam Integer campusId, @RequestParam String openId,
			@RequestParam String title, @RequestParam String Send_Type, @RequestParam String url,
			@RequestParam String first_data, @RequestParam String keyword1_data, @RequestParam String keyword2_data,
			@RequestParam String keyword3_data, @RequestParam String keyword4_data, @RequestParam String keyword5_data,
	...
	// 向承租人发隐患通知
	public void send(@RequestParam String guid, @RequestParam String check_id, String userName, String openId,
	...
	public void sendMessage(@RequestParam Integer place, @RequestParam String title, @RequestParam String Send_Type,
			@RequestParam String url, @RequestParam String first_data, @RequestParam String keyword1_data,
			@RequestParam String keyword2_data, @RequestParam String keyword3_data, @RequestParam String keyword4_data,
			@RequestParam String keyword5_data, @RequestParam String remark_data) {
		...
		try {
			...
			if (list != null) {
				...
				while (iterator.hasNext()) {
					...
					messageList.setCampusId(campusId);
					messageList.setOpenId(openId);
					messageList.setContext(
							keyword1_data + "," + keyword2_data + "," + keyword3_data + "," + keyword4_data);
					messageList.setType(Send_Type);
					messageList.setSendTime(new Date());
					if (s.equals("消息发送成功")) {
						messageList.setState(1);
	...
	public void sendMessage(@RequestParam Integer place, @RequestParam String title, @RequestParam String Send_Type,
			@RequestParam String url, @RequestParam String first_data, @RequestParam String keyword1_data,
			@RequestParam String keyword2_data, @RequestParam String keyword3_data, @RequestParam String keyword4_data,
			@RequestParam String keyword5_data, @RequestParam String remark_data, @RequestParam String currentOpenId) {
	...
	// 发送短信验证码
	public Integer sendPhoneMessage(String phone, String Message, String charter, String openId) {
	...
	public Integer sendMessage(@RequestParam String openId, @RequestParam String Template_Id,
			@RequestParam String Send_Type, @RequestParam String url, @RequestParam String first_data,
			@RequestParam String keyword1_data, @RequestParam String keyword2_data, @RequestParam String keyword3_data,
			@RequestParam String keyword4_data, @RequestParam String keyword5_data, @RequestParam String remark_data) {
	...
	public Integer sendMessage2(@RequestParam Integer campusId, @RequestParam String openId,
			@RequestParam String Template_Id, @RequestParam String Send_Type, @RequestParam String url,
			@RequestParam String first_data, @RequestParam String keyword1_data, @RequestParam String keyword2_data,
			@RequestParam String keyword3_data, @RequestParam String keyword4_data, @RequestParam String keyword5_data,
			@RequestParam String remark_data) {
		...
		try {
			...
			String s = wechatTemplate.sendTemplateMessage2(campusId, accessToken, templateData);
